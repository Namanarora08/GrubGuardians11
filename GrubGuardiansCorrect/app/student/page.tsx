...
import {
  ...
  initialFoodNotifications, // Import initialFoodNotifications
...
export default function StudentDashboardPage() {
  ...
  // Effect to initialize and refresh food notifications and claimed count
  useEffect(() => {
    // Initialize localStorage with mock data if it's empty (only on client)
    if (typeof window !== "undefined" && localStorage.getItem("grubguardians_food_notifications") === null) {
      localStorage.setItem("grubguardians_food_notifications", JSON.stringify(initialFoodNotifications))
    }
